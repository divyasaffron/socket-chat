...
<head>
	...
	$(document).ready(function(){
		var websocket = new WebSocket("ws://localhost:8090/simple-php-chat-using-websocket/php-socket.php"); console.log(websocket);
		...
		$('#frmChat').on("submit",function(event){
			...
			$('#chat-user-id').attr("type","hidden");		
			var messageJSON = {
				chat_id:$('#chat-user-id').val(),
	...
	<body>
		<form name="frmChat" id="frmChat">
			<div id="chat-box"></div>
			<input type="text" name="chat-user-id" id="chat-user-id" placeholder="ID" class="chat-input" required />
